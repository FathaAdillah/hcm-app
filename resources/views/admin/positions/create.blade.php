                    ...
                    <form action="{{ route('positions.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="jabatan_name" id="jabatan"
                                    value="">
                                <input type="hidden" name="jabatans_id" id="jabatans-id" value="">
                            </div>
                            <div class="form-group">
                                <label for="unit" class="form-label">Unit</label>
                                <input type="text" class="form-control" name="unit_name" id="unit" value="">
                                <input type="hidden" name="units_id" id="units-id" value="">
                            </div>
                            <div class="form-group">
                                <label for="position" class="form-label">Parent Position</label>
                                <input type="text" class="form-control" name="position_name" id="position"
                                    value="">
                                <input type="hidden" name="positions_id_parent" id="positions-id-parent" value="">
                            </div>
                        </div>
