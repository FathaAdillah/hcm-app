    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Tambah Geofencing</h2>
                <div class="card">
                    <form action="{{ route('geofencings.store') }}" method="POST">
                        @csrf
        ...
        {{-- <div id="mapModal" class="modal">
            <div class="modal-content">
                ...
                <div id="map"></div>
                <button class="btn btn-primary" id="saveLocationButton">Save Location</button>
            </div>
        </div> --}}
