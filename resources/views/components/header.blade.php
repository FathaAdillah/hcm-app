...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
                ...
                <img alt="image"
                    src="{{ auth()->user()->image_url ? asset('storage/' . auth()->user()->image_url) : asset('img/avatar/avatar-1.png') }}"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="{{ Route('reset-password') }}" class="dropdown-item has-icon">
                    <i class="fas fa-cog"></i> Reset Passwword
                </a>
